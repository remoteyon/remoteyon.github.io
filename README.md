...
## This project involves porting my website completely to GitHub

Feel free to inspect the code in case you need something similar for your projects.



### Objectives:

1. Complete independence from WYSIWYG editors
2. Ability to quickly port my website to a different service
3. Use AI for complex CSS and JS code
